...
def parse_args():
    ...
    parser.add_argument(
        "--images-dir",
        default="/home/pose3d/projs/STCN/UNet_Spine_Proj/UNet_Spine/data/imgs",
        type=str,
        help="dataset path",
    )
    parser.add_argument(
        "--masks-dir",
        default="/home/pose3d/projs/STCN/UNet_Spine_Proj/UNet_Spine/data/masks",
        type=str,
        help="masks path"
    )
    ...
    parser.add_argument("--is-fuzzy", default=False, type=bool)

    # train
    parser.add_argument("--batch-size", default=16, type=int)
    parser.add_argument("--learning-rate", default=1e-5, type=float)
    parser.add_argument("--num-epoch", default=500, type=int)
